                                                ...
                                                let
                                                    ...
                                                    in
                                                        if builtins.hasAttr type visitors then
                                                            ...
                                                            else if type == "set" then builtins.trace "${ builtins.typeOf visitors.set }" ( visitors.set path ( builtins.mapAttrs ( name : value : visit ( builtins.concatLists [ path [ name ] ] ) value ) ) value )
