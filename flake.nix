        ...
        { self } :
            {
                lib =
                    {
                        default ? path : value : builtins.throw "The definition at ${ builtins.map builtins.toJSON path } is invalid.  It is of type ${ builtins.typeOf value }.  It is ${ if builtins.any ( t : t == builtins.typeOf value ) [ "bool" "float" "int" "null" "path" "string" ] then "stringable" else "unstringable" }." ,
